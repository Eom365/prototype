        ...
        <>
            <div className="container">
                ...
                <p className="section-description">
                    Вариант параметра продукта позволяет объединить в одной карточке товара несколько исполнений,
                    отличающихся по выбранным характеристикам. Отметьте, какие характеристики могут меняться,
                    укажите их значения, создайте варианты, заполните их и отправьте на проверку.
                </p>
