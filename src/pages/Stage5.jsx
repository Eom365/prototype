...
function Stage5() {
    ...
    const save = async () => {
        ...
        await productsApi.saveDescription(productId, description)
        const values = Object.entries(specs).map(([code, value]) => ({
            code,
            value: value.value,
                    ...
                    {descriptionFields.map(([name, label]) => (
                        <div className="field" key={name}>
                            ...
                            <input
                                ...
                                onChange={(event) =>
                                    setDescription((prev) => ({ ...prev, [name]: event.target.value }))
                                }
